...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed in user" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :email => "another@exemple.com")
        third  = Factory(:user, :email => "another@exemple.net")
  ...
  describe "GET 'show'" do
    ...
    it "should include the users's image" do
      get :show, :id => @user
  ...
  describe "authentification of edit/update pages" do
    ...
    describe "for non-signed-in users" do
      ...
      it "should dejy acces to 'edit'" do
        get :edit, :id => @user
        response.should redirect_to(signin_path)
      end
    ...
    describe "for signed-in users" do
      before(:each) do
        wrong_user = Factory(:user, :email => "bad@boy.net")
